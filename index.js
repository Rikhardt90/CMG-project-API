...
const InstrumentRoutes = require("./src/api/instrument/instrument.routes");
const EffectsRoutes = require("./src/api/effects/effects.routes")
const RecordingRoutes = require("./src/api/recording/recording.routes")
